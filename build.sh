...
cppcheck . --enable=style --suppress=variableScope --suppress=unreadVariable --suppress=noExplicitConstructor -q -i fatfs/ -i Library/ -i Library/CMSIS/Driver/DriverTemplates/ -i Library/StdDriver/src/retarget.c -i LoRaMac-node/ -f --cppcheck-build-dir=build/cppcheck
